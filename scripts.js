...
//              downloadLink.download = 'recording.ogg'; // Filename for the downloaded file
...
//         // document.getElementById(`record-${language}`).style.display = 'none';
//         // document.getElementById(`stop-${language}`).style.display = 'block';
//     })
//     .catch(function(err) {
